    ...
    <div className="policy-page">
      ...
      <div className="section">
        ...
        <p>
          ...
          about our products. All products are carefully selected from the most
          reputable and quality suppliers.
        </p>
        <p>
      ...
      <div className="section">
        ...
        <p>
          ...
          eligible for a return, the product must be in its original condition,
      ...
      <div className="section">
        ...
        <p>
          Email: <a href="mailto:info@goldenkoi.com">goldenkoi.vn@gmail.com</a>
        </p>
        <p>
